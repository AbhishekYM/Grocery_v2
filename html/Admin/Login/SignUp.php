...
if (isset($_POST['submit'])) {
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    if ($user_password != $user_confpassword) {
      ...
      header('location:/Grocery/html/Admin/Team/Team.php');
    }
  }
}
?>
                ...
                <div class="row justify-content-center">
                  <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    ...
                    <form class=" " action="" method="post">
                      ...
                      <div class="">
                        <div class="  ">
                        <label  for="full_name" style="font-size: 1rem;">Full Name</label>
                          <input type="text" id="full_name" name="full_name" class="form-control" />
                        </div>
                      </div>
                      <div class="">
                        <div class="">
                        <label class="form-label" for="user_username" style="font-size: 1rem;">UserName</label>
                          <input type="text" id="user_username" name="user_username" class="form-control" />
                        </div>
                      </div>
                      <div class="">
                        <div class="">
                        <label class="form-label" for="user_email" style="font-size: 1rem;">Your Email</label>
                          <input type="email" id="user_email" name="user_email" class="form-control" />
                        </div>
                      </div>
                      <div class="">
                        <div class="">
                        <label class="form-label" for="user_password" style="font-size: 1rem;">Password</label>
                          <input type="password" id="user_password" name="user_password" class="form-control" />
                        </div>
                      </div>
                      <div class="">
                        <div class="">
                        <label class="form-label" for="user_confpassword" style="font-size: 1rem;"> Confirm Password</label>  
                      ...
                      <div class="">
                        <div class="">
                        <label class="form-label" for="user_mobile" style="font-size: 1rem;">Mobile</label>  
