...
<body class="bg-light">
    ...
    ?>
    <?php
    include '/var/www/html/Grocery/App/Features/Insert.php';
    ?>
    <br>
    <br>
    <br>
    <div class="container mt-3">
        <h1 class="text-center" style="color:#2697FF;" >Insert Features</h1>
        <!--Form-->
        <form action="/Grocery/App/Features/Insert.php" method="post" enctype="multipart/form-data" id="cat_image">
