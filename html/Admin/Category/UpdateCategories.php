    ...
    <div class="container mt-3">
        ...
        <form action="/Grocery/App/Category/Update.php" method="post" enctype="multipart/form-data" id="cat_image">
            <div class="form-outline mb-4 w-50 m-auto">
                <!--Insert - Category-->
                <input type="hidden" name="updateId" value="<?php echo $CategoryUpdate->id ;?>">
                <input type="text" name="cat_title" id="cat_title" class="form-control" placeholder="Enter category"
                    autocomplete="off" value=" <?php echo $CategoryUpdate->title; ?>">
            </div>
            <!--Image-->
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <img src='/Grocery/Storage/image/<?php echo $CategoryUpdate->image; ?>' </div style="
    width: 92px;
    margin-left: 656px;
    margin-top: -39px;
">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                value="<?php echo $CategoryUpdate->discount; ?>">
            </div>
            <!--Submit-->
            <div class="form-outline mb-4 w-50 m-auto">
