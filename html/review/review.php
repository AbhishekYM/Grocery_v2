...
<body class="bg-light">
    ...
    ?>
    <?php
    include 'D:/xampp/htdocs/Grocery/app/category/insert.php';
    ?>
    <br>
    <div class="container mt-3">
        <h1 class="text-center">Insert Reviews</h1>
        <!--Form-->
        <form action="/Grocery/app/category/insert.php" method="post" enctype="multipart/form-data" id="cat_image">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="cat_discount" id="cat_discount" class="form-control" autocomplete="off" required>
            </div>
            <!--Submit-->
            <div class="form-outline mb-4 w-50 m-auto">
