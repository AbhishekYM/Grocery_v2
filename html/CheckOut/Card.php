...
<head>
  ...
  <link rel="stylesheet" href="/Grocery/CSS/Card.css">
...
<body>
  ...
  <head>
    ...
    <link rel="stylesheet"
      href="https://fonts.googleapis.com/css?family=Playfair+Display|Quicksand:400,700|Open+Sans|PT+Mono" />
    <link rel="stylesheet"
  ...
  <body class="body">
    ...
    <section class="container">
      <h1 class="container__h1">Payment</h1>
      <div class="payment">
        ...
        <form class="card-form" method="POST">
          <div class="field">
            <svg version="1.1" class="card-icon" xmlns="http://www.w3.org/2000/svg"
              ...
              <g transform="translate(1 1)">
                ...
                <path style="fill:#c9c9d9;"
                  d="M348.867,237.933c-33.28,0-59.733-26.453-59.733-59.733s26.453-59.733,59.733-59.733
                ...
                <g>
                  <path style="fill:#c9c9d9;"
                    d="M408.6,237.933c-33.28,0-59.733-26.453-59.733-59.733s26.453-59.733,59.733-59.733
                ...
                <path style="fill:#c9c9d9;"
                  d="M135.533,383H41.667v-68.267h93.867V383z M58.733,365.933h59.733V331.8H58.733V365.933z" />
                <polygon style="fill:#c9c9d9"
                  points="161.133,323.267 237.933,323.267 237.933,374.467 161.133,374.467" />
                <path style="fill:#c9c9d9;"
                  d="M246.467,383H152.6v-68.267h93.867V383z M169.667,365.933H229.4V331.8h-59.733V365.933z" />
                <polygon style="fill:#c9c9d9"
                  points="272.067,323.267 348.867,323.267 348.867,374.467 272.067,374.467" />
                <path style="fill:#c9c9d9;"
                  d="M357.4,383h-93.867v-68.267H357.4V383z M280.6,365.933h59.733V331.8H280.6V365.933z" />
                <polygon style="fill:#c9c9d9;" points="383,323.267 459.8,323.267 459.8,374.467 383,374.467" />
                <path style="fill:#c9c9d9;"
                  d="M468.333,383h-93.867v-68.267h93.867V383z M391.533,365.933h59.733V331.8h-59.733V365.933z" />
              </g>
            </svg>
            <input id="card-number" class="field__input" type='tel' name='card-number' placeholder='1234 5678 9123 4567'
              maxlength="20" />
          </div>
          <div class="field field--space">
            <svg version="1.1" class="card-icon" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px"
              viewBox="0 0 600.112 600.111" style="enable-background:new 0 0 600.112 600.111;" xml:space="preserve">
              <g>
                <g>
                  <g>
                    <path style="fill:#c9c9d9;"
            ...
            <input id="expires-month" class="field__input field__input--cardexp-1" type="tel" name="expires-month"
              placeholder="MM" allowed-pattern="[0-9]" maxlength="2" />
            <svg version="1.1" class="card-icon" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px"
              viewBox="0 0 600.112 600.111" style="enable-background:new 0 0 600.112 600.111;" xml:space="preserve">
              <g>
            ...
            <input id="expires-year" class="field__input field__input--cardexp-2" type="tel" name="expires-year"
              placeholder="YY" allowed-pattern="[0-9]" maxlength="2" />
          </div>
          <div class="field">
            <svg version="1.1" class="card-icon" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px"
              ...
              <g transform="translate(1 1)">
                ...
                <g>
                  <path style="fill:#c9c9d9;"
                    d="M511,195.267H-1v-85.333h512V195.267z M16.067,178.2h477.867V127H16.067V178.2z" />
                ...
                <path style="fill:#c9c9d9;"
                  d="M348.867,400.067c-33.28,0-59.733-26.453-59.733-59.733s26.453-59.733,59.733-59.733
                ...
                <path style="fill:#c9c9d9;"
                  d="M408.6,400.067c-33.28,0-59.733-26.453-59.733-59.733S375.32,280.6,408.6,280.6
            ...
            <input id="card-cvc" class="field__input field__input--cardcvc" type="tel" name="cardcvc" placeholder="123"
              maxlength="3" autocomplete="off" />
          </div>
          <input type="number" name="GetNumberFrom" placeholder="Enter Mobile Number">
          <button class="button" type="submit" name="submit">Submit</button>
        </form>
      </div>
    </section>
    <script src="/Grocery/html/Payment/Card.js"></script>
...
if (isset($_POST['submit'])) {
  ...
  // curl_setopt($ch, CURLOPT_USERPWD, 'AC4f9a7304a9ef50736449b62a14c957b3:252dac742c944e6ede97a0fcb7981fd5');
  ...
  // echo($otp);
  // if () {
  //   header("location:/Grocery/html/payment/otp.php");
  // }
}
?>