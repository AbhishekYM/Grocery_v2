...
if (isset($_POST['insert_product'])) {
    ...
    $insert_product = "insert into product(code,category,brand,title,price,description,
    featured_image,qty,status) values('$code','$product_category','$product_brand',
    ' $product_title','$product_price','$description','$product_image','$quantity','$status')";
